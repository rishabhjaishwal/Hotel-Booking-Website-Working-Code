...
$res=mysqli_query($con,"Select * from contactenquirey") or die(mysqli_error($con));
...
echo"<th class='w3-teal text-center'>Delete</th><th class='w3-teal text-center'>".$colname[0]->name."</th><th class='w3-teal text-center'>".$colname[1]->name."</th><th class='w3-teal text-center'>".$colname[2]->name."</th><th class='w3-teal text-center'>".$colname[3]->name."</th><th class='w3-teal text-center'>".$colname[4]->name."</th>";

while($row=mysqli_fetch_array($res))
{?>
<tr><td><div class="checkbox checkbox-info checkbox-circle">
<?php
echo"<input type='checkbox' name='ids[]' id='$row[0]' value='$row[0]' />"."<label for='$row[0]'>"."select for delete"."</label>"."</div>"."<a href='deletequery.php?id=$row[0]' class='btn w3-teal'>"."delete"."</a>"."</td><td>".$row[0]."</td><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td></tr>";
