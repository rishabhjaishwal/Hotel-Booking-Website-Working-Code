...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<form action="checklogin.php" class="form-group" method="post">
			<label>Email/Username</label><input type="text" name="email" placeholder="USERNAME" class="form-control" required>
			<br><label>Password</label><input type="password" name="password" placeholder="PASSWORD" class="form-control" required>
			<br><input type="submit" class="btn btn-lg btn-primary form-control" value="LOGIN"  class="form-control" >
			</form>		
